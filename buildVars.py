...
addon_info = {
	...
	"addon_name": "NVDAext_Alcatel-Lucent-4059mac",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	"addon_summary": _("Alcatel-Lucent 4059 IP - NVDA add-on"),
	# Add-on description
	...
	"addon_url": "https://github.com/TybotFr/NVDAext_Alcatel-Lucent-4059mac",
	# URL for the add-on repository where the source code can be found
	"addon_sourceURL": "https://github.com/TybotFr/NVDAext_Alcatel-Lucent-4059mac",
	# Documentation file name
	"addon_docFileName": "readme.html",
	# Minimum NVDA version supported (e.g. "2018.3.0", minor version is optional)
	"addon_minimumNVDAVersion": "2022.3.2",
	# Last NVDA version supported/tested (e.g. "2018.4.0", ideally more recent than minimum version)
	"addon_lastTestedNVDAVersion": "2022.3.2",
